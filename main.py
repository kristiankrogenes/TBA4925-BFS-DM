...
class CFG():
    ...
    def __init__(self, epochs, size, batch_size, timesteps, model_path=None, backbone=False, save_model=None, default=False):
        ...
        elif check_parameters_for_training(epochs, size, batch_size, timesteps, model_path, save_model):
...
if __name__ == "__main__":
    ...
    cfg = CFG(args.epochs, args.size, args.batch_size, args.timesteps, args.model_path, args.backbone, args.save_model, args.default)
    ...
    bfs.train(start_epoch=cfg.start_epoch, epochs=cfg.epochs, parameterization="eps", save_model=cfg.save_model)